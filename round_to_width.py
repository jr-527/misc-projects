'''
This provides a function which rounds numbers to a desired width,
returning a string.
Unlike other implementations of rounding which I've seen, the rounded
number *always* fits within the desired width.
Ex:
round_to_width(1234,3) -> '1e3'
